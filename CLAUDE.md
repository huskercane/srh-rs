...
Phases 0–7 and 9 are complete. All three command routes authenticate static or Keycloak JWT
...
Phase 8 remains deferred. Deferred work is marked with `TODO(phaseN)` comments
